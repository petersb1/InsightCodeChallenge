...
All code was done independently of outside help. I never wrote a .sh run script before and appreciated the example. It did take a while to figure out off to call the correct file extensions from the run script in the python files. 

Thanks for the chance to participate. Being this was my first code challenge, I did my best to follow instructions. Please advise if I misinterpreted any of the directions.
